...
cp -a doc/html %{buildroot}%{_datadir}/doc/ofono-qt5/
...
%{_libdir}/%{name}.prl
%{_libdir}/%{name}.so
%{_libdir}/pkgconfig/ofono-qt5.pc
%{_includedir}/ofono-qt5/libofono-qt_global.h
%{_includedir}/ofono-qt5/ofono*.h
%{_datadir}/qt5/mkspecs/features/ofono-qt5.prf
# >> files devel
# << files devel

%files doc
%defattr(-,root,root,-)
%doc %{_datadir}/doc/ofono-qt5/
# >> files doc
# << files doc
